...
2. *(to be finalized once the walking skeleton lands — exact install/run/seed commands go here, e.g. `pip install -r requirements.txt`, environment variable setup, `uvicorn app.main:app --reload`, and a seed script for demo data)*
3. Open the documented demo path and follow it end to end.
